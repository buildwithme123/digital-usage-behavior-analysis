...
SUGGESTIONS = {
    'Daily Smartphone Usage (hrs)': {'high': "Set screen-time limits (under 3 hrs).", 'low': "Usage is well-controlled."},
    'Daily Social Media Time (hrs)': {'high': "Try a 30-min daily cap on social apps.", 'low': "Social media time is healthy."},
    'Notification Checking Frequency': {'high': "Use 'Do Not Disturb' while studying.", 'low': "Great focus habits."},
    'Phone Use Before Sleep': {'high': "Stop using phone 60 min before bed.", 'low': "Good sleep hygiene."},
    'Daily Sleep (hrs)': {'low': "Aim for 7–8 hours to boost performance.", 'high': "Excellent sleep duration."},
    'Daily Study Hours': {'low': "Try Pomodoro sessions (25 min on, 5 min off).", 'high': "Consistent study habits."},
    'Focus During Study': {'low': "Remove phone from your study area.", 'high': "Focus is your main driver."},
    'Device Addiction Level': {'high': "Try a weekly 'digital detox' day.", 'low': "Healthy device control."}
}
...
if st.button("Generate Detailed Report"):
    data = {
        ...
        'How many hours do you study daily?': study_map[study_hrs], 'what is your cgpa?': cgpa_map[cgpa_val],
